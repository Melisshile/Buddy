...
- Competition readiness, audit, career-story demo script, **judge Q&A**, **architecture**, **final submission checklist**.
- MIT `LICENSE`.
- **Developer Mode** metrics panel (model, agents, latency, twin/tools) for judges.
...
- Demo-first Dashboard (Career Intelligence home) + active status beats in Conversation Workspace.
- Codex model routing for Coding Agent (`gpt-5.2-codex`).

### Changed
- Product positioning: AI Career Operating System (not chat clone).
- Language: Career Intelligence, Career Memory, Growth Progress, Conversation Workspace.
- Demo narrative: “I want to become an AI Engineer.” → plan → “Build today's project.”
- Vision **frozen** for Build Week — demo reliability over new features.
